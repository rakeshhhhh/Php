...
?>
 ...
 <tr>
       <td>Password : </td>
       <td><input type="password" placeholder="Enter Password" name="pass" value="<?php echo $pass; ?>"></td>
    </tr>
 <tr>
       <td>Confirmpassword : </td>
       <td><input type="password" placeholder="Re-Enter Password" name="pass1" value="<?php echo $pass1; ?>"></td>
    </tr>
